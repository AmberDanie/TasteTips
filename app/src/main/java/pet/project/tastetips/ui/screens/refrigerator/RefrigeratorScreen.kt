...
import pet.project.tastetips.model.productDateToPattern
...
fun RefrigeratorScreen(viewModel: TasteTipsViewModel) {
    ...
    val homeUiState by uiState.refrigeratorItems.collectAsState()

    val currentProducts = homeUiState.itemList
        ...
        Scaffold(
            ...
            LazyColumn(
                ...
                items(currentProducts) {
                    ...
                    ) { coroutineScope.launch { viewModel.removeRefrigeratorItem(it) } }
                }
            }
        }
    }
    if (uiState.isChoosable) {
        RefrigeratorDialog(
            ...
            text = uiState.dialogName,
            date = uiState.dialogDate,
    ...
    Card(
        ...
        Row(horizontalArrangement = Arrangement.SpaceBetween,
            ...
            modifier = Modifier
                .fillMaxWidth()) {
            Icon(
                imageVector = refrigeratorIcons[refrigeratorItem.positionIcon].filledIcon,
